...
export const MetaDescription = '《考试 A+ 助手》，一款基于 Next.js 的 考试 A+ 助手应用，通过使用 excel 文件形式的考题文件，转换成 JSON 数据，展现在考题页面，形成一个供用户练习考题的应用。';
export const MetaKeyWord = '考试，考试题库，练习，考试练习，助手，应用，excel，2020，金护帽，消防测试';
